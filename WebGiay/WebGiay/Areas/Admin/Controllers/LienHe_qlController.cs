...
{
    public class LienHe_qlController : Controller
    {
        ...
        // GET: Admin/LienHe_ql/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/LienHe_ql/Create

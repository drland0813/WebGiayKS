...
namespace WebGiay.Areas.Admin.Controllers
{
    public class KhuyenMaiController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_KM,tuNgay,denNgay,giaSale")] KhuyenMai khuyenMai)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_KM,tuNgay,denNgay,giaSale")] KhuyenMai khuyenMai)
        {
            if (ModelState.IsValid)
            {
